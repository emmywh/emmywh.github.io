...
## Final Project Report - Emily White
My goal for this semester was to grow my web development skills through completion of a Udemy course and the creation of a basic website. I completed the first, but not the latter. I was really impressed with the detail and resources the Udemy course provided. I ended up spending more time exploring those that I thought I would. This slowed my progress on the course, but I have a better understanding of each topic and how to find information. 

One of my risks explained in my proposal explained the Udemy course was ~60 hours of material and our project was to be a maximum of ~45 hours, I mitigated this by monitoring my time and picking the most relevant modules under each topic. I was successful at this, but decided to continue with the course further to not lose momentum in completing it. This led to having less time to build a website. I picked out a dataset for a website for population data on Antarctic penguins and made a web UI design for it. Then I decided I would rather make a web scraping website that involved my fiber arts hobby, I could go much farther with this and would rather work on something I could use and develop further, 

At this point, I had hit the time limit for the project. My perfectionism and lack of passion for my original idea ended up altering my goals, which is something I want to be able to avoid in my workflow in the future through better planning. Otherwise, I was able to complete all other project assessments. I learned (and worked with in course activities) React and SQL. I ended up using Docker to spin up a local Postgres database and connected to it via my IDE to run some SQL. As far as hosting goes, I learned how to host a website through Github, but I am interested in hosting my website on a major cloud provider like AWS or a smaller hosting service like Vercel.

With more resources at my disposal and more practice, I have more confidence in my software development skills. Most importantly, I can learn skills and develop my knowledge base independently using online courses and practice by making my own projects. Knowing what and where to find resources regarding web development and tooling has been the greatest takeaway of this course.
